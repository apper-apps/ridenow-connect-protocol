...
<ApperIcon name={service.icon || service.icon_c} size={24} className="text-white" />
        </div>
        <div className="flex-1">
<h3 className="text-xl font-semibold text-gray-900 mb-2">{service.name || service.Name}</h3>
<p className="text-gray-600 mb-4">{service.description || service.description_c}</p>
          <div className="flex items-center justify-between">
            <span className="text-primary font-semibold">
Starting at ₹{service.basePrice || service.base_price_c}/km
            </span>
            <Link to={link}>
